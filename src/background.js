...
const notifyAboutBalance = (currentBalance, prevBalance, lastNotificationTime, interval) => {
  ...
  if (fixedCurrentBalance !== fixedprevBalance && fixedCurrentBalance < (fixedprevBalance * 2)) sendMessage('03', 'Your balance is fast ending', `In half an hour he has changed from ${prevBalance} to ${currentBalance}.`, buttons, iconUrl);
}
